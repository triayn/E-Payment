 ...
 * @author Tria
 */
public class GagalHapusData extends javax.swing.JDialog {

    /**
     * Creates new form BerhasilEditData
     */
    public GagalHapusData(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/gagalHapus.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GagalHapusData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GagalHapusData dialog = new GagalHapusData(new javax.swing.JFrame(), true);
