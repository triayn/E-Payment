 ...
 * @author Tria
 */
public class BerhasilExport extends javax.swing.JDialog {

    /**
     * Creates new form BerhasilEditData
     */
    public BerhasilExport(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/BerhasilExport.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BerhasilExport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BerhasilExport dialog = new BerhasilExport(new javax.swing.JFrame(), true);
