 ...
 * @author Tria
 */
public class TabelKosong extends javax.swing.JDialog {

    /**
     * Creates new form BerhasilEditData
     */
    public TabelKosong(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/TabelKosong.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TabelKosong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TabelKosong dialog = new TabelKosong(new javax.swing.JFrame(), true);
