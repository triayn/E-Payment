 ...
 * @author Tria
 */
public class IsiJumlah extends javax.swing.JDialog {

    private boolean isClose = false;
    
    public IsiJumlah(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/IsiJumlah.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IsiJumlah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IsiJumlah dialog = new IsiJumlah(new javax.swing.JFrame(), true);
