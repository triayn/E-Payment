 ...
 * @author Tria
 */
public class BerhasilHapusData extends javax.swing.JDialog {

    
    private boolean isClose = false;
    
    public BerhasilHapusData(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/hapusData.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BerhasilHapusData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BerhasilHapusData dialog = new BerhasilHapusData(new javax.swing.JFrame(), true);
