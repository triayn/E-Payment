 ...
 * @author Tria
 */
public class KonfirmasiPassword extends javax.swing.JDialog {

    /**
     * Creates new form BerhasilEditData
     */
    public KonfirmasiPassword(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KonfirmasiPassword.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                KonfirmasiPassword dialog = new KonfirmasiPassword(new javax.swing.JFrame(), true);
