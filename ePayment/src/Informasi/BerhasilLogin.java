 ...
 * @author Tria
 */
public class BerhasilLogin extends javax.swing.JDialog {

    /**
     * Creates new form BehasilLogin
     */
    public BerhasilLogin(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/berhasilLogin.png"))); // NOI18N
  ...
  int key = evt.getKeyCode();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BerhasilLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BerhasilLogin dialog = new BerhasilLogin(new javax.swing.JFrame(), true);
