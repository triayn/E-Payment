 ...
 * @author Tria
 */
public class BerhasilTambahData extends javax.swing.JDialog {

    /**
     * Creates new form BerhasilTambahData
     */
    public BerhasilTambahData(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/tambahData.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BerhasilTambahData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BerhasilTambahData dialog = new BerhasilTambahData(new javax.swing.JFrame(), true);
