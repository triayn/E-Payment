 ...
 * @author Tria
 */
public class IsiTunai extends javax.swing.JDialog {

    private boolean isClose = false;
    
    public IsiTunai(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/IsiTunai.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IsiTunai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IsiTunai dialog = new IsiTunai(new javax.swing.JFrame(), true);
