 ...
 * @author Tria
 */
public class PembayaranKurang extends javax.swing.JDialog {

    private boolean isClose = false;
    
    public PembayaranKurang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/PembayaranKurang.png"))); // NOI18N
        ...
        CloseNotification.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyReleased(java.awt.event.KeyEvent evt) {
                CloseNotificationKeyReleased(evt);
            }
        });
    ...
    private void CloseNotificationKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CloseNotificationKeyReleased
        this.isClose = false;
        this.dispose();
    }//GEN-LAST:event_CloseNotificationKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PembayaranKurang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PembayaranKurang dialog = new PembayaranKurang(new javax.swing.JFrame(), true);
