 ...
 * @author Tria
 */
public class HapusOwner extends javax.swing.JDialog {

    /**
     * Creates new form HapusOwner
     */
    public HapusOwner(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/hapusOwner.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HapusOwner.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                HapusOwner dialog = new HapusOwner(new javax.swing.JFrame(), true);
