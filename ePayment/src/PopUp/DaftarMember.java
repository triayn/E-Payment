...
public class DaftarMember extends javax.swing.JDialog {

    public DaftarMember(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void btn_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_simpanActionPerformed
        ...
        if (kode.equals("")) {
            ...
            try {
                ...
                statement.executeUpdate(String.format("insert into member VALUES "
                        + "('" + kode + "','" + nama + "','" + notelp + "',"
                        + "'" + alamat + "','" + TanggalMember + "');"));
                statement.close();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DaftarMember dialog = new DaftarMember(new javax.swing.JFrame(), true);
