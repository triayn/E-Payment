 ...
 * @author Tria
 */
public class DaftarSupplier extends javax.swing.JDialog {

    /**
     * Creates new form Supplier
     */
    public DaftarSupplier(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        refresh();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DaftarSupplier dialog = new DaftarSupplier(new javax.swing.JFrame(), true);
